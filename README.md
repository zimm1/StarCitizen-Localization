...
|--------------------------|-----------|--------|
| English                  | ![Static Badge](https://img.shields.io/badge/4.5.0-LIVE-brightgreen) | Imported from game files |
...
| Portuguese - Brazil      | ![Static Badge](https://img.shields.io/badge/4.5.0-LIVE-brightgreen) | Here |
