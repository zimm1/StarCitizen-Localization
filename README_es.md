...
| ----------------------- | ------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------- |
| Inglés                  | ![Static Badge](https://img.shields.io/badge/4.5.0-LIVE-brightgreen)   | Importado de archivos del juego                                                                                                     |
...
| Portugués (Brasil)      | ![Static Badge](https://img.shields.io/badge/4.5.0-LIVE-brightgreen)   | Aquí                                                                                                                                |
