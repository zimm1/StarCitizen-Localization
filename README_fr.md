...
|--------------------------|----------------|--------|
| Anglais                 | ![Static Badge](https://img.shields.io/badge/4.5.0-LIVE-brightgreen) | Importé des fichiers du jeu |
...
| Portugais - Brésil      | ![Static Badge](https://img.shields.io/badge/4.5.0-LIVE-brightgreen) | Ici |
