...
|--------------------------|-----------|-------|
| Inglês                  | ![Static Badge](https://img.shields.io/badge/4.5.0-LIVE-brightgreen) | Importado dos arquivos do jogo |
...
| Português - Brasil      | ![Static Badge](https://img.shields.io/badge/4.5.0-LIVE-brightgreen) | Aqui |
